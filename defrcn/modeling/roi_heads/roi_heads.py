...
class CommonalityROIHeads(ROIHeads):
    ...
    def forward(
        ...
        use_gt_boxes = (
            (not self.training)
            and self.attribute_branch
            and self.use_gt_bbox
        ...
        self.attribute_branch._cache_bg_filter_context(images, proposals, batched_inputs, targets)
        ...
        if self.training:          
            ...
            if self.attribute_branch and self.attribute_branch._attribute_warmup_active(storage):
                ...
                subs_cls_loss = self.attribute_branch._compute_subs_cls_loss(
                    outputs
                )
                if subs_cls_loss is not None:
                    losses["loss_cls"] = subs_cls_loss
